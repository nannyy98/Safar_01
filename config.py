...
FLASK_SECRET_KEY = os.getenv('FLASK_SECRET_KEY', 'change-me-now')
ADMIN_NAME = os.getenv('ADMIN_NAME', 'AdminUser')
RATE_LIMIT = int(os.getenv('RATE_LIMIT', '20'))
JWT_SECRET = os.getenv('JWT_SECRET', 'change_me_jwt')
ENCRYPTION_KEY = os.getenv('ENCRYPTION_KEY', 'change_me_encryption')

# --- Payments (stubs) ---
PAYME_MERCHANT_ID = os.getenv('PAYME_MERCHANT_ID', '')
PAYME_KEY = os.getenv('PAYME_KEY', '')
PAYME_CALLBACK_SECRET = os.getenv('PAYME_CALLBACK_SECRET', '')
CLICK_MERCHANT_ID = os.getenv('CLICK_MERCHANT_ID', '')
CLICK_SERVICE_ID = os.getenv('CLICK_SERVICE_ID', '')
CLICK_SECRET = os.getenv('CLICK_SECRET', '')

# --- Features toggles ---
AUTONOTIFY_ENABLED = os.getenv('AUTONOTIFY_ENABLED', '0')  # '1' to enable
