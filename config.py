...
# Никаких настоящих токенов в коде.
BOT_TOKEN = os.getenv('TELEGRAM_BOT_TOKEN')
if not BOT_TOKEN:
    raise RuntimeError("TELEGRAM_BOT_TOKEN is not set. Configure env on Render.")

# Канал, куда бот шлёт посты (автопосты, send_now)
# Можно -100XXXXXXXXXXXX или @username канала
